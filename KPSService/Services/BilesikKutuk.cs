...
namespace KPSService
{
    public class BilesikKutuk
    {
        ...
        public BilesikKutuk(long _tc, int _yil, int _ay, int _gun)
        {
            ...
            channelFactory = new ChannelFactory<BilesikKutukSorgulaKimlikNoServis>("CustomBinding_BilesikKutukSorgulaKimlikNoServis", new EndpointAddress(KPSConfiguration.Instance.EndPoint));
        ...
        public BilesikKutukBilgileriSonucu getSonuc()
        {
            ...
            BilesikKutukSorgulaKimlikNoServis servis = channelFactory.CreateChannelWithIssuedToken(KPSServiceFactory.Instance.CreateToken());
